<template>
  <div class="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50">
    <button
      @click="openLine"
      class="bg-green-500 hover:bg-green-600 text-white w-12 h-12 md:w-14 md:h-14 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95"
