...
useSeoMeta({
  title: '服務項目與價目表 - 專業推拿調理',
  description: '查看我們詳細的服務項目與價格，包含本月優惠、一般推拿、指壓油壓等。點擊價目表可放大查閱。',
  ogTitle: '服務項目與價目表 - 專業推拿調理',
  ogDescription: '查看我們詳細的服務項目與價格，包含本月優惠、一般推拿、指壓油壓等。',
})
    ...
    <div class="container mx-auto px-4 py-8">
      <div class="grid grid-cols-3 gap-4 md:gap-8">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden group">
          <h2 class="text-lg font-bold text-gray-800 text-center py-3 bg-gray-50">本月優惠</h2>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden group">
          <h2 class="text-lg font-bold text-gray-800 text-center py-3 bg-gray-50">價目表</h2>
          <div class="p-2 md:p-4">
            <img 
              src="/images/價目表.jpg" 
              alt="推拿服務價目表" 
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden group">
          <h2 class="text-lg font-bold text-gray-800 text-center py-3 bg-gray-50">指壓/油壓</h2>
          <div class="p-2 md:p-4">
            <img 
              src="/images/指壓油壓.jpg" 
              alt="指壓與油壓方案價格" 
